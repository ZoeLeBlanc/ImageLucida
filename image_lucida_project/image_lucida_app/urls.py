...
urlpatterns = [
    ...
    url(r'^get_single_project/(?P<project_id>\d+)/$', project_view.get_single_project, name= 'get_single_project'),
    ...
    url(r'^duplicate_project/(?P<project_id>\d+)/$', project_view.duplicate_project, name= 'duplicate_project'),
    # folder urls
    url(r'^get_single_folder/(?P<folder_id>\d+)/$', folder_view.get_single_folder, name= 'get_single_folder'),
    url(r'^get_folders/(?P<project_id>\d+)/$', folder_view.get_folders, name= 'get_folders'),
    url(r'^cu_folder/', folder_view.cu_folder, name= 'cu_folder'),
    url(r'^delete_folder/', folder_view.delete_folder, name= 'delete_folder'),
    url(r'^duplicate_folder/(?P<folder_id>\d+)/$', folder_view.duplicate_folder, name= 'duplicate_folder'),
    # bucket urls
    url(r'^get_buckets/(?P<folder_id>\d+)/$', bucket_view.get_buckets, name= 'get_buckets'),
    url(r'^get_single_bucket/(?P<bucket_id>\d+)/$', bucket_view.get_single_bucket, name= 'get_single_bucket'),
    ...
    url(r'^upload_process_file/', uploadfile_view.upload_process_file, name='upload_process_file'),
    ...
    # source urls
    url(r'^get_sources/(?P<bucket_id>\d+)/$', source_view.get_sources, name= 'get_sources'),
    url(r'^get_single_source/(?P<source_id>\d+)/$', source_view.get_single_source, name= 'get_single_source'),
    url(r'^cu_source/', source_view.cu_source, name= 'cu_source'),
    url(r'^delete_source/', source_view.delete_source, name= 'delete_source'),
    # group urls
    url(r'^get_groups/(?P<source_id>\d+)', group_view.get_groups, name= 'get_groups'),
    url(r'^get_single_group/(?P<group_id>\d+)/$', group_view.get_single_group, name= 'get_single_source'),
    ...
    url(r'^get_contours/', imagefile_view.get_contours, name='get_contours'),
    url(r'^order_image/', imagefile_view.order_image, name= 'order_image'),
    url(r'^contains_image/', imagefile_view.contains_image, name='contains_image'),
